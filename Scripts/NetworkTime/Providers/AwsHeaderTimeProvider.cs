...
namespace TinyUtilities.NetworkTime.Providers {
    internal sealed class AwsHeaderTimeProvider : ITimeProvider {
        private const string _URL = "https://aws.amazon.com";
        ...
        public async UniTask<TimeResult> GetTime(CancellationToken cancellation) {
            try {
                ...
                Debug.LogWarning(new Exception("AwsHeaderProvider.GetTime", exception));
            }
