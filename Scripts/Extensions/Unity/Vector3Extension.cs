...
namespace TinyUtilities.Extensions.Unity {
    public static class Vector3Extension {
        ...
        [Pure]
        public static Vector3 OffsetX(this Vector3 vector, float value) => new Vector3(vector.x + value, vector.y, vector.z);
        
        [Pure]
        public static Vector3 OffsetY(this Vector3 vector, float value) => new Vector3(vector.x, vector.y + value, vector.z);
        
        [Pure]
        public static Vector3 OffsetZ(this Vector3 vector, float value) => new Vector3(vector.x, vector.y, vector.z + value);
